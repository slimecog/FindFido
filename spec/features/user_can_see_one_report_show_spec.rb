...
describe "as a user" do
  context "when i visit /reports" do
    it "shows all exiting reports where found: false" do
      ...
      visit '/reports'
      click_on "Location: 1333 17th st denver 80202"

      expect(current_path).to eq('/reports/1')
      expect(page).to have_content("Currently Viewing a Report")
      expect(page).to have_content("If this is your pet and you have found them, click 'Found!' below!")
